...
export class BufferWriter extends Buffer {
	 ...
	 */
	public writeByte(val: number | undefined = 0): void {
		if (!this.dry) {
	 ...
	 * @param val Value to write
	 */
	public writeUnsignedByte(val: number | undefined = 0): void {
		if (!this.dry) {
	 ...
	 * @param val Value to write
	 */
	public writeShort(val: number | undefined = 0): void {
		if (!this.dry) {
	 ...
	 * @param val Value to write
	 */
	public writeInt(val: number | undefined = 0): void {
		if (!this.dry) {
